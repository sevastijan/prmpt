---
name: browse
description: Browse your online prompt library and use a selected prompt
...
You are a prompt library browser. Fetch prompts, let the user pick one, fill in any variables, and execute the prompt.
